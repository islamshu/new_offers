...
<div class="topbar">
    ...
    @if (config('layout.extras.languages.display'))
        ...
        @endphp
            ...
            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                    <img class="h-20px w-20px rounded-sm" @if($lang == 'ar') src="{{ asset('media/svg/flags/008-saudi-arabia.svg') }}"  @else  src="{{ asset('media/svg/flags/226-united-states.svg') }}" @endif alt=""/>
                </div>
            </div>
