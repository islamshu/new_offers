...
<div class="card card-custom">
    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <div class="example-tools justify-content-center">
                ...
                <div>
                    <a href="{{ route('download.brands', app()->getLocale()) }}"
                        class="btn btn-primary">{{ __('donwlod sample') }}</a> 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="{{ route('export.category', app()->getLocale()) }}"
                            class="btn btn-primary">{{ __('donwlod category') }}</a>
                </div>
    ...
    <form method="post" action="{{ route('post.import', ['locale' => app()->getLocale()]) }}"
