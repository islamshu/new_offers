...
card card-docs mb-2">
    <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
        <h2 class="mb-3">All Countries</h2>
        ...
        <table class="datatable table datatable-bordered datatable-head-custom  table-row-bordered gy-5 gs-7"
            ...
            <tbody>
                ...
                <td> @if(app()->getLocale() == "en"){{$item->name_en}}
                    @elseif(app()->getLocale() == "ar")
                    {{$item->name_ar}}
                    @endif</td>
                 <td><img src="{{URL::asset('images/brand/'.$item->image)}}"style="width: 30px"></td>
                <td>{{$item->uuid}}</td>
                ...
                <td class="pr-0 text-right">
                    ...
                    <a href="{{route('vendor.show', ['vendor'=>$item->id,'locale'=>app()->getLocale()])}}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                    ...
                    <a href="{{ route('vendor.edit', ['vendor'=>$item->id,'locale'=>app()->getLocale()]) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                        <span class="svg-icon svg-icon-md svg-icon-primary">
