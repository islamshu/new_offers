...
<div class="card card-custom">
    ...
    <div class="card-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/{{ get_lang() }}/create_vendor_branches/{{ $vendor->id }}"><i class="fa fa-dashboard"></i> {{ $vendor->name_en}} Branches</a></li>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="city custom-select " id="city_id" name="city_id">
                        <option value="" selected disabled  >{{ __('choose city') }}</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ex: 27,85487" id="latitude"
                            name="latitude">
                    </div>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Ex: 27,85487" id="longitude"
                            name="longitude">
                    </div>
                </div>
                <div class="col-12">
