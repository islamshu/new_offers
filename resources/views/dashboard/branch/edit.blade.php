            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="neighborhood custom-select" id="neighborhood_id"  name="neighborhood_id">
                        ...
                        @foreach (\App\Models\Vendor_neighborhood::where('vendor_id',$branch->vendor_id)->with('neighborhood')->get(); as $item)
                        <option value="{{ $item->neighborhood->id }} " @if($branch->neighborhood_id ==  $item->neighborhood->id ) selected @endif>{{ $item->neighborhood->neighborhood_name_english }}</option>
                    @endforeach
