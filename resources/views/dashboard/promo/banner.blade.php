        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="div" style="float: right">
                <a href="{{ route('create_item', [app()->getLocale(), 'banner', $city_id]) }}"
                    class="btn btn-info">{{ __('create banner') }}</a>
            </div>
            @endif
            <br>
            <div class="mt-10">
                ...
                <table class="datatable table datatable-bordered datatable-head-custom  table-row-bordered gy-5 gs-7"
                    ...
                    <tbody>
                        @foreach ($premotions as $item)
                            ...
                            <td><img src="{{ asset('images/banner/' . $item->image) }}" width="100" height="100" alt="">
                            </td>
                            <td>{{ $item->url }}</td>


                            <td>{{ $item->homeslider->title_en }}</td>
