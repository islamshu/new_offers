                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group col-md-5 mb-3">
                            ...
                            <input type="date" value="{{ $request->created_form }}" id="created_form"
                                placeholder="Created From" class="form-control" name="created_form">
                        </div>
                        ...
                        <div class="input-group col-md-5 mb-3">
                            ...
                            <input type="date" value="{{ $request->created_to }}" id="created_to"
                                placeholder=" Created To" class="form-control" name="created_to">
                        </div>
                        <div class="input-group col-md-5 mb-3">
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="inputGroupSelect01">
                            ...
                            <select name="vendor_status" id="vendor_status" class="selectpicker form-control"
                                ...
                                <option value="deactive" @if ($request->vendor_status == 'deactive') selected @endif> deactive
                                </option>
                            </select>
                        </div>
                        <div class="input-group col-md-5 mb-3">
                            ...
                            <select name="offer_status" id="offer_status" class="selectpicker form-control"
                                ...
                                <option value="deactive" @if ($request->offer_status == 'deactive') selected @endif> deactive
                                </option>
                            </select>
                        </div>
                        <div class="input-group col-md-5 mb-3">
                            ...
                            <select name="city_id" id="city_id" class="form-control">
                                ...
                                @foreach (App\Models\City::where('status', 1)->get() as $item)
                                    <option value="{{ $item->id }}" @if ($request->city_id == $item->id) selected @endif>
                        ...
                        <div class="input-group col-md-5 mb-3">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                ...
                                @foreach (App\Models\Category::where('is_show', 1)->get() as $item)
                                    <option value="{{ $item->id }}" @if ($request->category_id == $item->id) selected @endif>
                                        {{ $item->name_en }} </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="input-group col-md-5 mb-3">
                            <div class="input-group-prepend">
                                ...
                                <input type="number" value="{{ $request->number_date }}" placeholder="Expired after"
                                    class="form-control" id="number_date" name="number_date">
