                ...
                <thead>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('get_detelis',['en','MADA',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $mada+ $mada_arabic }}</a></td>
                        <td>{{ $summada + $summada_arabic  }}SR</td>
