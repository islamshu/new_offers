        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <table class="datatable table datatable-bordered datatable-head-custom " style="width: 50%">
                <thead>
                    ...
                    <tr class="fw-bold fs-6 text-gray-800">
                        <th>{{ __('Trial') }}</th>
                        <td><a href="{{ route('get_detelis',['en','trial',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $trial }}</a></td>
                        <td>_</td>
                    </tr>
                    <tr>
                        <th>{{ __('By Admin') }}</th>
                        <td><a href="{{ route('get_detelis',['en','admin',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $admin }}</a></td>
                        <td>_</td>
                    </tr>
                   <tr>
                    <th>{{ __('By Excel') }}</th>
                    <td><a href="{{ route('get_detelis',['en','excel_import',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $excel }}</a></td>
                    <td>_</td>
                    </tr>
                    <tr>
                        <th>{{ __('Activation Code') }}</th>
                        <td><a href="{{ route('get_detelis',['en','activition_code',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $activation }}</a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('get_detelis',['en','VISA/MASTER',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $visa }}</a></td>
                        <td>{{ $sumvisa }}SR</td>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('get_detelis',['en','STC Pay',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $stc }}</a></td>
                        <td>{{ $sumstc }}SR</td>
                    ...
                    <tr>
                        <th> <img src="https://e7.pngegg.com/pngimages/462/855/png-clipart-apple-pay-google-pay-payment-samsung-pay-apple-text-logo.png" width="50" height="20" alt="">
                            &nbsp;	&nbsp;	     {{ __('   Apple pay') }}</th>
                        <td><a href="{{ route('get_detelis',['en','Apple Pay',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $applepay }}</a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('get_detelis',['en','Apple Pay (Mada)',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $applepaymada }}</a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('get_detelis',['en','MADA',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{ $mada }}</a></td>
                        <td>{{ $summada   }}SR</td>

                    </tr>
                    <tr>
                        <th> <img src="data:image/png;base64," width="50" height="20" alt="">  &nbsp;	&nbsp;	 {{ __('   مدى') }}</th>
                        <td><a href="{{ route('get_detelis',['en','MADA',$request->date_from ? $request->date_from : 'from',$request->date_to ? $request->date_to : 'to']) }}">{{  $mada_arabic }}</a></td>
                        <td>{{ $summada_arabic  }}SR</td>
