        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="sender_id" id="sender_id" class="form-control form-control-solid"
                        placeholder="Enter Sender Id"  />
                </div>
                <div class="form-group col-md-6">
                    <label>{{ __('Token for sms') }}:</label>
                    <input type="text" name="sms_token" id="sms_token" class="form-control form-control-solid"
                        placeholder="Token for sms"  />
                </div>
                <div class="form-group col-md-6">
                    <label>{{ __('password for sms') }}:</label>
                    <input type="text" name="sms_password" id="sms_password" class="form-control form-control-solid"
