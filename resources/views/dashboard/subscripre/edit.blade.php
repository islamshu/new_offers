        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" id="desc_ar" rows="3">{{ $sub->desc_ar }}</textarea>
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleTextarea">{{ __('Desc en') }} <span class="text-danger">*</span></label>
                    <textarea class="form-control" id="desc_en" rows="3">{{ $sub->desc_en }}</textarea>
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleTextarea">{{ __('Terms ar') }}<span class="text-danger">*</span></label>
                    <textarea class="form-control" id="terms_ar" rows="3">{{ $sub->terms_ar }}</textarea>
                </div>
                <div class="form-group col-md-6">
                    <label for="exampleTextarea">{{ __('Terms en') }} <span class="text-danger">*</span></label>
                    <textarea class="form-control" id="terms_en" rows="3">{{ $sub->terms_en }}</textarea>
                </div>
                <div class="form-group col-md-6">
                    <label>{{ __('type_paid') }}:</label>
                    <select class="form-control form-control-solid restricted" name="type_paid" id="type_paid">
                        <option value="trial"  @if($sub->type_paid == 'trial') selected @endif>{{ __('trial') }}</option>
                        <option value="paid"  @if($sub->type_paid == 'paid') selected @endif>{{ __('paid') }}</option>
                    </select>
                </div>
                <div class="form-group col-md-6 trial_class" @if($sub->type_paid != 'trial') style="display:none" @endif>
                    <label>{{ __('Days of trial') }}:</label>
                    <input type="number" name="days_of_trial" value="{{ $sub->days_of_trial }}" id="days_of_trial" class="form-control form-control-solid"
                        placeholder="Enter Days of trial" required />
                </div>
                <div class="form-group col-md-6">
                    <label>{{ __('Price') }}:</label>
                    <input type="number" name="price" id="price" value="{{ $sub->price }}" class="form-control form-control-solid"
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control form-control-solid restricted" name="expire_date_type" id="expire_date_type">
                        <option value="days" @if($sub->expire_date_type == 'days') selected @endif>{{ __('days') }}</option>
                        <option value="months" @if($sub->expire_date_type == 'months') selected @endif>{{ __('months') }}</option>
                        <option value="years" @if($sub->expire_date_type == 'years') selected @endif>{{ __('years') }}</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
                    <label>{{ __('Number of Date') }}:</label>
                    <input type="number" value="{{ $sub->number_of_dayes }}" name="number_of_dayes" id="number_of_dayes" class="form-control form-control-solid"
                ...
                {{-- <div class="form-group col-md-6">
                    ...
                    <select class="form-control form-control-solid restricted" name="type" id="type">
                        <option value="coupons"  @if($sub->type == 'coupons') selected @endif>{{ __('coupons') }}</option>
                        <option value="points"  @if($sub->type == 'points') selected @endif>{{ __('') }}</option>
                    </select>
                </div> --}}
                <div class="form-group col-md-6">
                    <div class="rule">
                        ...
                        <select class="form-control form-control-solid restricted" name="add_members" id="add_members">
                            <option value="active" @if($sub->add_members == 'active') selected @endif>{{ __('active') }}</option>
                            <option value="deactive" @if($sub->add_members == 'deactive') selected @endif>{{ __('deactive') }}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" name="number_of_members" value="{{ $sub->number_of_members }}" id="number_of_members" class="form-control form-control-solid"
