        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" id="desc_en" rows="3">{{ $sub->desc_ar }}</textarea>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="price" value="{{ $sub->price }}" id="price" class="form-control form-control-solid"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6 type_balance" @if( $sub->type_balance == 'UnLimit') style="display: none" @else  style="display: block" @endif >
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control form-control-solid restricted" name="expire_date_type" id="expire_date_type">
                        <option value="days" @if( $sub->expire_date_type == 'days') selectd @endif >{{ __('days') }}</option>
                        <option value="months" @if( $sub->expire_date_type == 'months') selectd @endif>{{ __('months') }}</option>
                        <option value="years" @if( $sub->expire_date_type == 'years') selectd @endif>{{ __('years') }}</option>
                    </select>
                </div>
                <div class="form-group col-md-6">
                    <label>{{ __('Number of Date') }}:</label>
                    <input type="number" name="number_of_dayes" value="{{ $sub->number_of_dayes }}" id="number_of_dayes" class="form-control form-control-solid"
                ...
                <div class="form-group col-md-6">
                    <div class="rule">
                        ...
                        <select class="form-control form-control-solid restricted" name="add_members" id="add_members">
                            <option value="" selected disabled>{{ __('chose option') }}</option>
                            <option value="active" @if( $sub->add_members == 'active') selectd @endif >{{ __('active') }}</option>
                            <option value="deactive" @if( $sub->add_members == 'deactive') selectd @endif >{{ __('deactive') }}</option>
                        </select>
                    </div>
                </div>

                <div class="form-group col-md-6 add_members" @if( $sub->add_members == 'deactive') style="display: none" @else style="display: block" @endif>
