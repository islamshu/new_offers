            ...
            @if (auth()->user()->isAbleTo(['create-category']))
                <div>
                    <a class="btn btn-info"
                        href="{{ route('category.create', app()->getLocale()) }}">{{ __('Create category') }}</a>
                </div>
            @endif
                ...
                <tbody class="sort_menu">
                    @foreach ($categorys as $key => $item)
                        <tr data-id="{{ $item->id }}">
                            ...
                            <td><img src="{{ asset('images/category/' . $item->image) }}" width="50" height="50" alt="">
                            </td>
                            <td>{{ $item->title }}</td>
                            <td>
                            ...
                            <td class="pr-0 text-left">
                                @if (auth()->user()->isAbleTo(['update-category']))
                                    <a href="{{ route('category.edit', ['category' => $item->id, 'locale' => app()->getLocale()]) }}"
