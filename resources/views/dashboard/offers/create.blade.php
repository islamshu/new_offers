                        ...
                        <form class="form" method="post" id='kt_form' enctype="multipart/form-data">
                            ...
                            <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid form-control-lg"
                                                id="name_ar" name="name_ar" required placeholder="Name ar" />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid form-control-lg"
                                                id="name_en" name="name_en" required placeholder="Name en" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 usage_member_number" style="display: none">
                                        <!--begin::Input-->
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <select name="delivery" class="form-control form-control-solid form-control-lg"
                                                ...
                                                <option value="buyOneGetOne">{{ __('buyOneGetOne') }}</option>
                                                <option value="special_discount">{{ __('special discount') }}</option>
                                                <option value="general_offer">{{ __('general discount') }}</option>
...
@section('scripts')
    ...
    <script src="{{ asset('js/pages/custom/wizard/wizard-11.js') }}"></script>
