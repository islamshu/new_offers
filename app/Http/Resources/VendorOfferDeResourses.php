...
class VendorOfferDeResourses extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return[
            ...
            'is_limited_period_between_redeems'=> $this->datetime_use =='active' ? 1 : 0,
            'period_limit_between_redeems'=> $this->datetime_use == 'active' ? $this->datatime_number : null,
