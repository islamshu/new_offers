...
class ClientTwoResoures extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'birth_date'=>date('Y-m-d', strtotime((string)$this->birth_date)),
            ...
            'actual_accounts_no'=>$this->actual_accounts_no != 0 ? $this->actual_accounts_no : null,            // 'status'=>$this->status == 'active' ? 1 : 0 ,
